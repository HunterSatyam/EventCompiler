    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.data.success) {
                ...
                setFormData({ title: '', companyName: '', description: '', location: '', salary: '', experience: 0, position: 1, type: 'Job', file: null });
    ...
    return (
        <div className='max-w-7xl mx-auto my-20 px-4'>
            <div className='flex justify-between items-center mb-5'>
                <h1 className='text-4xl font-extrabold'><span className='text-[#6A38C2]'>Latest & Top </span> Job Openings</h1>
                {user?.role === 'recruiter' && (
                    <button
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 my-5'>
                {
                    allJobs.length <= 0 ? <span className="text-gray-500 text-lg">No Job Available</span> : allJobs?.filter(job => job.jobType === 'Job').slice(0, 6).map((job) => <JobCard key={job._id} job={job} />)
                }
            </div>
                        ...
                        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                ...
                                <div>
                                    ...
                                    <input
                                        type="number" name="salary" placeholder="Example: 12"
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                <div>
                                    <label className='block text-sm font-medium text-gray-700'>For Experience (Years)</label>
                                    <input
                                        type="number" name="experience" placeholder="0 for freshers"
